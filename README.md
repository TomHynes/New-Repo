# Generated by BootMap on Mon May 05 2014 14:24:10 GMT-0400 (Eastern Daylight Time)
...
Additionally, once you have connected your app to a gitbut repo, you can use `grunt deploy` and it will automagically take the current master branch and deploy it to `gh-pages`, which makes it publicly accessible at [http://TomHynes.github.io/test-bootmap](http://TomHynes.github.io/test-bootmap). Hotness!
...
## Contributing to `test-bootmap` - uuh...  you need to fill this out eh :)
